...
// Consulta personalizada para obtener proyectos relacionados al usuario logueado
$crud = new Crud($conn);
$sql = "SELECT DISTINCT p.* 
        ...
        WHERE 
            p.supervisor = :idColab
            OR ec.id_colab = :idColab
            OR t.propietario = :idColab";
...
if (is_array($proyectos) && count($proyectos) > 0) {
  ...
  echo '<tr><td colspan="9" class="text-center">No hay proyectos registrados.</td></tr>';
}
